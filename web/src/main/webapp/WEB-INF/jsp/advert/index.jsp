...
<body>
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<button type="button" class="btn btn-primary"
							style="float: right;"
							onclick="window.location.href='${APP_PATH}/advert/add.htm'">
	...
	<script type="text/javascript">
            			...
            			if(result.success){
            				...
            				$.each(list,function(i,n){
								...
								if(n.status=='0'){
									...
									content+="	<td>未审核</td><td>";
									content+="   <button type='button' class='btn btn-success btn-xs'><i class='glyphicon glyphicon-check'></i></button>";
								}else if(n.status=='2'){
									content+="	<td>审核完成</td><td>";
								...
								content+="		<button type='button' onclick='window.location.href=\"${APP_PATH}/advert/toEdit.htm?pageno="+pageObj.pageno+"&id="+n.id+"\"' class='btn btn-primary btn-xs'>";
            ...
            function deleteAdvert(id,name){
    			...
    			layer.confirm("是否要删除《"+name+"》广告?",  {icon: 3, title:'提示'}, function(cindex){
            ...
            $("#batchDelete").click(function(){
            	...
            	if(checkedList.length>0){
            		layer.confirm("确定要删除这些广告吗?",  {icon: 3, title:'提示'}, function(cindex){
