...
<div class="container">
    ...
    <form class="form-signin" actioon="${APP_PATH}/doLogin.do" method="post">
        ...
        <div class="form-group has-success has-feedback">
            <input type="text" class="form-control" id="formLoginacct" name="loginacct" placeholder="请输入登录账号" autofocus>
            <span class="glyphicon glyphicon-user form-control-feedback"></span>
        </div>
        <div class="form-group has-success has-feedback">
            <input type="text" class="form-control" id="formUserpswd" name="userpswd" placeholder="请输入登录密码" style="margin-top:10px;">
