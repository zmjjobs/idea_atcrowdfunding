...
<html lang="zh-CN">
  <head>
  	<title>尚筹网-权限管理-许可维护-添加许可</title>
    <meta charset="UTF-8">
			  ...
			  <div class="panel-body">
				<form role="form" id="addForm">
				  <div class="form-group">
					...
					<input type="text" class="form-control" id="fpermissionName" placeholder="请输入许可名称">
				  </div>
				  <div class="form-group">
					<label for="exampleInputPassword1">许可地址</label>
					<input type="text" class="form-control" id="fpermissionUrl" placeholder="请输入许可地址">
				  </div>
        ...
        <script type="text/javascript">
            $(function () {
			    ...
			    $("#insertBtn").click(function(){
			    	...
			    	$.ajax({
			    		type : "POST",
			    		url : "${APP_PATH}/permission/doAdd.do", //去往真正添加的方法
			    		data : {
			    		...
			    		success : function(result){
			    			...
			    			if(result.success){//如果添加成功去往user/index.jsp
			    				layer.msg("数据保存成功，正在跳转页面......",{time:1000, icon:6});
			    		...
			    		error : function(){
			    			layer.msg("添加许可失败！", {time:2000, icon:5, shift:6});
			    		} 
			    	});
			    	return;
			    });
