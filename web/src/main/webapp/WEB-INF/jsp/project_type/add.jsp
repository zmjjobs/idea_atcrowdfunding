    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      <div class="container-fluid">
        <div class="navbar-header">
            <div><a class="navbar-brand" style="font-size:32px;" href="${APP_PATH}/user/user.htm">众筹平台 - 用户维护</a></div>
        </div>
			  ...
			  <div class="panel-body">
				<form id = "reset">
				  ...
				  <div class="form-group">
					...
					<input type="text" class="form-control" id="fremark" placeholder="请输入简介">
				  </div>
			 ...
			 $.ajax({
				...
				success:function(result){
					...
					if(result.success){
						...
						window.location.href="${APP_PATH }/type/index.htm";
					}else{						
