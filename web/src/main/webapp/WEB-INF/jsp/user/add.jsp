...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container-fluid">
        <div class="navbar-header">
            <div><a class="navbar-brand" style="font-size:32px;" href="${APP_PATH}/user/toIndex.htm">众筹平台 - 用户维护</a></div>
        </div>
                ...
                <div class="panel-body">
                    <form role="form">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="formLoginacct" placeholder="请输入登录账号">
                        </div>
                        <div class="form-group">
                            <label for="formUsername">用户名称</label>
                            <input type="text" class="form-control" id="formUsername" placeholder="请输入用户名称">
                        </div>
                        <div class="form-group">
                            <label for="formEmail">邮箱地址</label>
                            <input type="email" class="form-control" id="formEmail" placeholder="请输入邮箱地址">
    ...
    $(function () {
        ...
        $("#insertBtn").click(function(){
            ...
            $.ajax({
                ...
                error : function(){
                    layer.msg("添加用户失败！",{time:1000,icon:5,shift:6});
                }
            });
            return;
        });
