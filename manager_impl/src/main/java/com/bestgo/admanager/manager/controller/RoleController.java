...
public class RoleController {
	...
	public Object doAssignRolePermission(DataForParam datas, Integer roleId){
		AjaxResult result = new AjaxResult();
		try {
			int count = roleService.saveRolePermissionRelationship(datas.getIds(),roleId);
	...
	public Object assign(Integer roleid,Map<String,Object> map){
	...
	public Object batchDelete(DataForParam datas){
		AjaxResult result = new AjaxResult();
		try {
